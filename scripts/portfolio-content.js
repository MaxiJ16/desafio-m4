function addPortfolioContent(params = {}) {
  ...
  //one 
  const imgCardOne = template.content.querySelectorAll(".card__img")[2];
...
function getPortfolioContent() {
  return fetch('https://cdn.contentful.com/spaces/j7x7byynhemm/environments/master/entries?access_token=gRBax9-L1fx6zwVsR8EVUT-qwb9zotugaJw2i5XITpo&content_type=dfm4Portfolio')
  .then((res) => {
    return res.json();
  })
  .then((json) => {
